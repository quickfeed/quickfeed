...
If you get a build error of a form:
...
One of the solutions is to go to uncomment or change `DOCKER_OPTS` line in `/etc/default/docker` file, then restart Docker deamon with `service docker restart`.
