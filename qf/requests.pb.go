...
var file_qf_requests_proto_rawDesc = []byte{
	...
	0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x22, 0x06, 0x0a, 0x04, 0x56, 0x6f, 0x69,
	0x64, 0x42, 0x26, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
var file_qf_requests_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_qf_requests_proto_goTypes = []interface{}{
	...
	(*Void)(nil),                          // 23: qf.Void
	nil,                                   // 24: qf.Repositories.URLsEntry
	(*Course)(nil),                        // 25: qf.Course
	(*EnrollmentLink)(nil),                // 26: qf.EnrollmentLink
	(*Review)(nil),                        // 27: qf.Review
	(*User)(nil),                          // 28: qf.User
	(Enrollment_UserStatus)(0),            // 29: qf.Enrollment.UserStatus
	(Submission_Status)(0),                // 30: qf.Submission.Status
	(Repository_Type)(0),                  // 31: qf.Repository.Type
}
var file_qf_requests_proto_depIdxs = []int32{
	25, // 0: qf.CourseSubmissions.course:type_name -> qf.Course
	26, // 1: qf.CourseSubmissions.links:type_name -> qf.EnrollmentLink
	27, // 2: qf.ReviewRequest.review:type_name -> qf.Review
	8,  // 3: qf.Organizations.organizations:type_name -> qf.Organization
	28, // 4: qf.Reviewers.reviewers:type_name -> qf.User
	29, // 5: qf.EnrollmentRequest.statuses:type_name -> qf.Enrollment.UserStatus
	29, // 6: qf.EnrollmentStatusRequest.statuses:type_name -> qf.Enrollment.UserStatus
	30, // 7: qf.UpdateSubmissionRequest.status:type_name -> qf.Submission.Status
	31, // 8: qf.URLRequest.repoTypes:type_name -> qf.Repository.Type
	24, // 9: qf.Repositories.URLs:type_name -> qf.Repositories.URLsEntry
