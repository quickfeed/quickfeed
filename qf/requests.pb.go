...
func (SubmissionsForCourseRequest_Type) EnumDescriptor() ([]byte, []int) {
	return file_qf_requests_proto_rawDescGZIP(), []int{21, 0}
}
...
var file_qf_requests_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x6e, 0x22, 0x06, 0x0a, 0x04, 0x56, 0x6f, 0x69, 0x64, 0x42, 0x26, 0x5a, 0x21, 0x67,
...
var file_qf_requests_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_qf_requests_proto_goTypes = []interface{}{
	...
	(*AuthorizationResponse)(nil),         // 20: qf.AuthorizationResponse
	(*Status)(nil),                        // 21: qf.Status
	(*SubmissionsForCourseRequest)(nil),   // 22: qf.SubmissionsForCourseRequest
	(*RebuildRequest)(nil),                // 23: qf.RebuildRequest
	(*CourseUserRequest)(nil),             // 24: qf.CourseUserRequest
	(*Void)(nil),                          // 25: qf.Void
	nil,                                   // 26: qf.Repositories.URLsEntry
	(*Course)(nil),                        // 27: qf.Course
	(*EnrollmentLink)(nil),                // 28: qf.EnrollmentLink
	(*Review)(nil),                        // 29: qf.Review
	(*User)(nil),                          // 30: qf.User
	(Enrollment_UserStatus)(0),            // 31: qf.Enrollment.UserStatus
	(Submission_Status)(0),                // 32: qf.Submission.Status
	(Repository_Type)(0),                  // 33: qf.Repository.Type
}
var file_qf_requests_proto_depIdxs = []int32{
	27, // 0: qf.CourseSubmissions.course:type_name -> qf.Course
	28, // 1: qf.CourseSubmissions.links:type_name -> qf.EnrollmentLink
	29, // 2: qf.ReviewRequest.review:type_name -> qf.Review
	8,  // 3: qf.Organizations.organizations:type_name -> qf.Organization
	30, // 4: qf.Reviewers.reviewers:type_name -> qf.User
	31, // 5: qf.EnrollmentRequest.statuses:type_name -> qf.Enrollment.UserStatus
	31, // 6: qf.EnrollmentStatusRequest.statuses:type_name -> qf.Enrollment.UserStatus
	32, // 7: qf.UpdateSubmissionRequest.status:type_name -> qf.Submission.Status
	33, // 8: qf.URLRequest.repoTypes:type_name -> qf.Repository.Type
	26, // 9: qf.Repositories.URLs:type_name -> qf.Repositories.URLsEntry
...
func file_qf_requests_proto_init() {
	...
	file_qf_requests_proto_msgTypes[22].OneofWrappers = []interface{}{
