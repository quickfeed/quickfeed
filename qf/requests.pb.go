...
var file_qf_requests_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x22, 0x61, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f, 0x73,
	...
	0x4c, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x71, 0x66, 0x2e, 0x52, 0x65,
	...
	0x02, 0x38, 0x01, 0x22, 0x32, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a,
	...
	0x52, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x74, 0x0a, 0x0e, 0x52, 0x65, 0x62, 0x75, 0x69,
	0x6c, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x6f, 0x75,
	...
	0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x44, 0x12, 0x22, 0x0a, 0x0c, 0x73, 0x75, 0x62,
	0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x0c, 0x73, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x22, 0x06, 0x0a,
	0x04, 0x56, 0x6f, 0x69, 0x64, 0x42, 0x26, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_qf_requests_proto_goTypes = []interface{}{
	...
	(*RepositoryRequest)(nil),             // 11: qf.RepositoryRequest
	(*Repositories)(nil),                  // 12: qf.Repositories
	(*Status)(nil),                        // 13: qf.Status
	(*RebuildRequest)(nil),                // 14: qf.RebuildRequest
	(*Void)(nil),                          // 15: qf.Void
	nil,                                   // 16: qf.Repositories.URLsEntry
	(*Course)(nil),                        // 17: qf.Course
	(*EnrollmentLink)(nil),                // 18: qf.EnrollmentLink
	(*Review)(nil),                        // 19: qf.Review
	(Enrollment_UserStatus)(0),            // 20: qf.Enrollment.UserStatus
	(Submission_Status)(0),                // 21: qf.Submission.Status
}
var file_qf_requests_proto_depIdxs = []int32{
	17, // 0: qf.CourseSubmissions.course:type_name -> qf.Course
	18, // 1: qf.CourseSubmissions.links:type_name -> qf.EnrollmentLink
	19, // 2: qf.ReviewRequest.review:type_name -> qf.Review
	20, // 3: qf.EnrollmentRequest.statuses:type_name -> qf.Enrollment.UserStatus
	0,  // 4: qf.SubmissionRequest.Type:type_name -> qf.SubmissionRequest.SubmissionType
	21, // 5: qf.UpdateSubmissionRequest.status:type_name -> qf.Submission.Status
	16, // 6: qf.Repositories.URLs:type_name -> qf.Repositories.URLsEntry
