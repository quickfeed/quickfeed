...
func (SubmissionRequest_SubmissionType) EnumDescriptor() ([]byte, []int) {
	return file_qf_requests_proto_rawDescGZIP(), []int{9, 0}
}
...
var file_qf_requests_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x49, 0x44, 0x22, 0x2b, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x47,
	...
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x6c, 0x61, 0x6e, 0x22, 0xba, 0x01, 0x0a, 0x11, 0x45, 0x6e,
...
var file_qf_requests_proto_goTypes = []interface{}{
	...
	(*GetGroupRequest)(nil),               // 4: qf.GetGroupRequest
	(*GroupRequest)(nil),                  // 5: qf.GroupRequest
	(*OrgRequest)(nil),                    // 6: qf.OrgRequest
	(*Organization)(nil),                  // 7: qf.Organization
	(*EnrollmentRequest)(nil),             // 8: qf.EnrollmentRequest
	(*EnrollmentStatusRequest)(nil),       // 9: qf.EnrollmentStatusRequest
	(*SubmissionRequest)(nil),             // 10: qf.SubmissionRequest
	(*UpdateSubmissionRequest)(nil),       // 11: qf.UpdateSubmissionRequest
	(*UpdateSubmissionsRequest)(nil),      // 12: qf.UpdateSubmissionsRequest
	(*URLRequest)(nil),                    // 13: qf.URLRequest
	(*RepositoryRequest)(nil),             // 14: qf.RepositoryRequest
	(*Repositories)(nil),                  // 15: qf.Repositories
	(*Status)(nil),                        // 16: qf.Status
	(*RebuildRequest)(nil),                // 17: qf.RebuildRequest
	(*Void)(nil),                          // 18: qf.Void
	nil,                                   // 19: qf.Repositories.URLsEntry
	(*Course)(nil),                        // 20: qf.Course
	(*EnrollmentLink)(nil),                // 21: qf.EnrollmentLink
	(*Review)(nil),                        // 22: qf.Review
	(Enrollment_UserStatus)(0),            // 23: qf.Enrollment.UserStatus
	(Submission_Status)(0),                // 24: qf.Submission.Status
	(Repository_Type)(0),                  // 25: qf.Repository.Type
}
var file_qf_requests_proto_depIdxs = []int32{
	20, // 0: qf.CourseSubmissions.course:type_name -> qf.Course
	21, // 1: qf.CourseSubmissions.links:type_name -> qf.EnrollmentLink
	22, // 2: qf.ReviewRequest.review:type_name -> qf.Review
	23, // 3: qf.EnrollmentRequest.statuses:type_name -> qf.Enrollment.UserStatus
	23, // 4: qf.EnrollmentStatusRequest.statuses:type_name -> qf.Enrollment.UserStatus
	0,  // 5: qf.SubmissionRequest.Type:type_name -> qf.SubmissionRequest.SubmissionType
	24, // 6: qf.UpdateSubmissionRequest.status:type_name -> qf.Submission.Status
	25, // 7: qf.URLRequest.repoTypes:type_name -> qf.Repository.Type
	19, // 8: qf.Repositories.URLs:type_name -> qf.Repositories.URLsEntry
...
func file_qf_requests_proto_init() {
	...
	file_qf_requests_proto_msgTypes[9].OneofWrappers = []interface{}{
