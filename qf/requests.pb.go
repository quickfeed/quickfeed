...
func (SubmissionsForCourseRequest_Type) EnumDescriptor() ([]byte, []int) {
	return file_qf_requests_proto_rawDescGZIP(), []int{22, 0}
}
...
func (x *CourseUserRequest) Reset() {
	*x = CourseUserRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_qf_requests_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CourseUserRequest) Descriptor() ([]byte, []int) {
	return file_qf_requests_proto_rawDescGZIP(), []int{24}
}
...
func (x *Void) Reset() {
	*x = Void{}
	if protoimpl.UnsafeEnabled {
		mi := &file_qf_requests_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Void) Descriptor() ([]byte, []int) {
	return file_qf_requests_proto_rawDescGZIP(), []int{25}
}
...
var file_qf_requests_proto_rawDesc = []byte{
	...
	0x6f, 0x54, 0x79, 0x70, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x71,
	...
	0x71, 0x66, 0x2e, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x2e,
	...
	0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e, 0x71, 0x66, 0x2e, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73,
	...
	0x0a, 0x04, 0x56, 0x6f, 0x69, 0x64, 0x42, 0x26, 0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x71, 0x75, 0x69, 0x63, 0x6b, 0x66, 0x65, 0x65, 0x64, 0x2f, 0x71,
	0x75, 0x69, 0x63, 0x6b, 0x66, 0x65, 0x65, 0x64, 0x2f, 0x71, 0x66, 0xba, 0x02, 0x00, 0x62, 0x06,
...
var file_qf_requests_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_qf_requests_proto_goTypes = []interface{}{
	...
	(*Providers)(nil),                     // 17: qf.Providers
	(*URLRequest)(nil),                    // 18: qf.URLRequest
	(*RepositoryRequest)(nil),             // 19: qf.RepositoryRequest
	(*Repositories)(nil),                  // 20: qf.Repositories
	(*AuthorizationResponse)(nil),         // 21: qf.AuthorizationResponse
	(*Status)(nil),                        // 22: qf.Status
	(*SubmissionsForCourseRequest)(nil),   // 23: qf.SubmissionsForCourseRequest
	(*RebuildRequest)(nil),                // 24: qf.RebuildRequest
	(*CourseUserRequest)(nil),             // 25: qf.CourseUserRequest
	(*Void)(nil),                          // 26: qf.Void
	nil,                                   // 27: qf.Repositories.URLsEntry
	(*Course)(nil),                        // 28: qf.Course
	(*EnrollmentLink)(nil),                // 29: qf.EnrollmentLink
	(*Review)(nil),                        // 30: qf.Review
	(*User)(nil),                          // 31: qf.User
	(Enrollment_UserStatus)(0),            // 32: qf.Enrollment.UserStatus
	(Submission_Status)(0),                // 33: qf.Submission.Status
	(Repository_Type)(0),                  // 34: qf.Repository.Type
}
var file_qf_requests_proto_depIdxs = []int32{
	28, // 0: qf.CourseSubmissions.course:type_name -> qf.Course
	29, // 1: qf.CourseSubmissions.links:type_name -> qf.EnrollmentLink
	30, // 2: qf.ReviewRequest.review:type_name -> qf.Review
	8,  // 3: qf.Organizations.organizations:type_name -> qf.Organization
	31, // 4: qf.Reviewers.reviewers:type_name -> qf.User
	32, // 5: qf.EnrollmentRequest.statuses:type_name -> qf.Enrollment.UserStatus
	32, // 6: qf.EnrollmentStatusRequest.statuses:type_name -> qf.Enrollment.UserStatus
	33, // 7: qf.UpdateSubmissionRequest.status:type_name -> qf.Submission.Status
	34, // 8: qf.URLRequest.repoTypes:type_name -> qf.Repository.Type
	27, // 9: qf.Repositories.URLs:type_name -> qf.Repositories.URLsEntry
...
func file_qf_requests_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_qf_requests_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_qf_requests_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Void); i {
			case 0:
				return &v.state
			case 1:
	...
	file_qf_requests_proto_msgTypes[23].OneofWrappers = []interface{}{
