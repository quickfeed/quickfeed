...
type Course struct {
	...
	Enrolled            Enrollment_UserStatus  `protobuf:"varint,12,opt,name=enrolled,proto3,enum=qf.Enrollment_UserStatus" json:"enrolled,omitempty"`
...
type Repository struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	ID                uint64                 `protobuf:"varint,1,opt,name=ID,proto3" json:"ID,omitempty"`
	ScmOrganizationID uint64                 `protobuf:"varint,2,opt,name=ScmOrganizationID,proto3" json:"ScmOrganizationID,omitempty"`
	...
	RepoType          Repository_Type        `protobuf:"varint,7,opt,name=repoType,proto3,enum=qf.Repository_Type" json:"repoType,omitempty"`
...
type Enrollment struct {
	...
	SlipDaysRemaining uint32                  `protobuf:"varint,10,opt,name=slipDaysRemaining,proto3" json:"slipDaysRemaining,omitempty"`
	LastActivityDate  *timestamppb.Timestamp  `protobuf:"bytes,11,opt,name=lastActivityDate,proto3" json:"lastActivityDate,omitempty"`
...
type Submission struct {
	...
	ApprovedDate  *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=approvedDate,proto3" json:"approvedDate,omitempty"`
...
type GradingBenchmark struct {
	...
	Criteria      []*GradingCriterion    `protobuf:"bytes,7,rep,name=criteria,proto3" json:"criteria,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Review struct {
	...
	GradingBenchmarks []*GradingBenchmark    `protobuf:"bytes,7,rep,name=gradingBenchmarks,proto3" json:"gradingBenchmarks,omitempty"`
...
type AssignmentFeedback struct {
	...
	TimeSpent              string                 `protobuf:"bytes,6,opt,name=TimeSpent,proto3" json:"TimeSpent,omitempty"`                           // Time used to complete the assignment
	CommitHash             string                 `protobuf:"bytes,7,opt,name=CommitHash,proto3" json:"CommitHash,omitempty"`                         // optional - most recent commit when feedback was given
	SubmissionID           uint64                 `protobuf:"varint,8,opt,name=SubmissionID,proto3" json:"SubmissionID,omitempty"`                    // optional - associated submission
...
const file_qf_types_proto_rawDesc = "" +
	...
	"\x06edited\x18\b \x01(\v2\x1a.google.protobuf.TimestampB0ʵ\x03,\xa2\x01)gorm:\"serializer:timestamp;type:datetime\"R\x06edited\"\x8a\x03\n" +
	...
	"\tTimeSpent\x18\x06 \x01(\tR\tTimeSpent\x12\x1e\n" +
	"\n" +
	"CommitHash\x18\a \x01(\tR\n" +
	"CommitHash\x12\"\n" +
	"\fSubmissionID\x18\b \x01(\x04R\fSubmissionID\x12j\n" +
	"\tCreatedAt\x18\t \x01(\v2\x1a.google.protobuf.TimestampB0ʵ\x03,\xa2\x01)gorm:\"serializer:timestamp;type:datetime\"R\tCreatedAtB&Z!github.com/quickfeed/quickfeed/qf\xba\x02\x00b\x06proto3"
