...
type Course struct {
	...
	SlackChannelLink    string                 `protobuf:"bytes,16,opt,name=SlackChannelLink,proto3" json:"SlackChannelLink,omitempty"` // Invite link to communication platform (e.g., Discord, Slack)
	SlackChannelName    string                 `protobuf:"bytes,17,opt,name=SlackChannelName,proto3" json:"SlackChannelName,omitempty"` // Description of the invite link (e.g., "Join our Discord server")
...
func (x *Course) GetSlackChannelLink() string {
	if x != nil {
...
func (x *Course) GetSlackChannelName() string {
	if x != nil {
...
const file_qf_types_proto_rawDesc = "" +
	...
	"\bAPPROVED\x10\x01\"+\n" +
	"\x06Groups\x12!\n" +
	"\x06groups\x18\x01 \x03(\v2\t.qf.GroupR\x06groups\"\xa3\x05\n" +
	"\x06Course\x12\x0e\n" +
	...
	"\benrolled\x18\f \x01(\x0e2\x19.qf.Enrollment.UserStatusB\x0fʵ\x03\v\xa2\x01\bgorm:\"-\"R\benrolled\x12*\n" +
	"\x10SlackChannelLink\x18\x10 \x01(\tR\x10SlackChannelLink\x12*\n" +
	"\x10SlackChannelName\x18\x11 \x01(\tR\x10SlackChannelName\x120\n" +
