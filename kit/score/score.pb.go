...
var file_score_proto_goTypes = []interface{}{
	...
	nil,            // 2: score.Scores.ScoreMapEntry
}
var file_score_proto_depIdxs = []int32{
	2, // 0: score.Scores.ScoreMap:type_name -> score.Scores.ScoreMapEntry
	0, // 1: score.Scores.ScoreMapEntry.value:type_name -> score.Score
