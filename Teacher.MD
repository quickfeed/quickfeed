...
## GitHub
 ...
 To use Autograder, both teachers and students must have an active GitHub account. https://github.com/
...
name: "lab1"
language: "go"
deadline: "2019-09-23T12:00:00"
autoapprove: false
isgrouplab: false
```

The `deadline` date format is `YYYY-MM-DD`.
