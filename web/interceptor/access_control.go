...
var methodCheckers = map[string]accessChecker{
	...
	"CreateNote":               checkTeacher,
	"UpdateNote":               checkTeacher,
	"DeleteNote":               checkTeacher,
	"GetNotes":                 checkTeacher,
	"GetCourseNotes":           checkTeacher,
...
// caller's JWT claims, once the handler receives the request message; see
// checkedConn for why the check cannot run before that.
