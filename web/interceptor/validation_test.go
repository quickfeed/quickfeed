...
func TestImplementsValidation(t *testing.T) {
	...
	tests := map[protoreflect.FullName]*struct {
		...
		"qf.UpdateSubmissionsRequest": {cleaner: F, validator: T},
...
func TestIsValid(t *testing.T) {
	tests := map[string]struct {
		...
		"UpdateSubmissionRequest/MissingCourse":      {request: &qf.UpdateSubmissionRequest{SubmissionID: 1}, want: false},
		"UpdateSubmissionRequest/MissingSubmission":  {request: &qf.UpdateSubmissionRequest{CourseID: 1}, want: false},
		"UpdateSubmissionRequest/Valid":              {request: &qf.UpdateSubmissionRequest{CourseID: 1, SubmissionID: 1}, want: true},
		"UpdateSubmissionsRequest/MissingCourse":     {request: &qf.UpdateSubmissionsRequest{AssignmentID: 1}, want: false},
		"UpdateSubmissionsRequest/MissingAssignment": {request: &qf.UpdateSubmissionsRequest{CourseID: 1}, want: false},
		"UpdateSubmissionsRequest/Valid":             {request: &qf.UpdateSubmissionsRequest{CourseID: 1, AssignmentID: 1}, want: true},
