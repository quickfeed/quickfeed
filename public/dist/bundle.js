...
const AdminPage_1 = __webpack_require__(44);
const NavBarLogin_1 = __webpack_require__(45);
const NavBarMenu_1 = __webpack_require__(46);
const LoginPage_1 = __webpack_require__(47);
const ServerProvider_1 = __webpack_require__(48);
...
class TeacherPage extends ViewPage_1.ViewPage {
    ...
    results(info) {
        ...
        const course = this.courseMan.getCourse(courseId);
        if (course) {
            const courseStds = this.courseMan.getUserIdsForCourse(course, models_1.CourseStudentState.accepted);
            const students = this.userMan.getUsers(courseStds.map((e) => e.personId));
            const labs = this.courseMan.getAssignments(courseId);
