...
const NavBarTeacher = () => {
    ...
    const teacherLinks = links.map((link) => { return React.createElement(NavBarLink, { key: link.text, link: link }); });
    return React.createElement(React.Fragment, null, teacherLinks);
};
