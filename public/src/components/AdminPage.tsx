...
export const AdminPage = () => {
    ...
    const editCourse = {title: "Edit Course", text: "Edit an existing course.", buttonText: "Edit Course", to: "/admin/create"}
    /** Button used to redirect a user, ex. return to top layer of course page */
    const RedirectButton = ({to}: {to: string}) => {
        const history  = useHistory()
        return (
        <div className={"btn btn-dark redirectButton"} onClick={() => history.push(to)}>
