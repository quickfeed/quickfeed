...
export interface ICourseProvider {
    ...
    addNewBenchmark( bm: BenchmarkRequest ): Promise<GradingBenchmark | null>
    addNewCriterion( c: CriteriaRequest ): Promise<GradingCriterion | null>
    updateBenchmark( bm: BenchmarkRequest ): Promise<boolean>
    updateCriterion( c: CriteriaRequest ): Promise<boolean>
    deleteBenchmark( bm: BenchmarkRequest ): Promise<boolean>
    deleteCriterion( c: CriteriaRequest ): Promise<boolean>
...
export class CourseManager {
    ...
    public async editReview( r: Review, courseID: number ): Promise<Review | null> {
