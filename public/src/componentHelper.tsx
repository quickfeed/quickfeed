...
import { Assignment, Course, Enrollment, Group, Review, User, Submission, GradingBenchmark, GradingCriterion } from "../proto/ag/types/types_pb"
...
export function userSubmissionLink( login: string, assignmentName: string, courseURL: string, style?: string ): JSX.Element {
    return <a className={ style } href={ labRepoLink( courseURL, login ) + "/tree/main/" + assignmentName } target="_blank">Open repository</a>
}
