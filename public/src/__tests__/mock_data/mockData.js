...
import { CourseSubmissionsSchema, OrganizationSchema, } from "../../../proto/qf/requests_pb";
import { AssignmentSchema, CourseSchema, Enrollment_DisplayState, Enrollment_UserStatus, EnrollmentSchema, EnrollmentsSchema, GradeSchema, GradingBenchmarkSchema, GradingCriterion_Grade, GradingCriterionSchema, Group_GroupStatus, GroupSchema, GroupsSchema, Repository_Type, ReviewSchema, Submission_Status, SubmissionSchema, SubmissionsSchema, UserSchema, } from "../../../proto/qf/types_pb";
import { SubmissionsForCourse } from "../../Helpers";
import { timestampFromDate } from "@bufbuild/protobuf/wkt";
export class MockData {
    static mockedUsers() {
        const userList = [];
        userList.push(create(UserSchema, {
            ID: BigInt(1),
            Name: "Test User",
    ...
    static mockedCourseAssignments() {
    ...
    static mockedEnrollments() {
        const enrollments = create(EnrollmentsSchema);
        const localEnrols = [];
        localEnrols.push(create(EnrollmentSchema, {
            ID: BigInt(1),
            courseID: BigInt(1),
            userID: BigInt(1),
    ...
    static mockedCourseSubmissions(courseID) {
    ...
    static mockedBenchmarks() {
        const templateBenchmarks = [];
        templateBenchmarks.push(create(GradingBenchmarkSchema, {
            ID: BigInt(1),
            AssignmentID: BigInt(1),
            heading: "HTML",
            criteria: [
