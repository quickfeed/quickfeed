...
var AutograderServiceClient = /** @class */ (function () {
    function AutograderServiceClient(hostname, credentials, options) {
        ...
        this.methodInfoGetSubmissionStream = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb_1.Submission, function (request) {
            return request.serializeBinary();
    ...
    AutograderServiceClient.prototype.getSubmissionStream = function (request, metadata) {
        return this.client_.serverStreaming(this.hostname_ +
            '/AutograderService/GetSubmissionStream', request, metadata || {}, this.methodInfoGetSubmissionStream);
    };
