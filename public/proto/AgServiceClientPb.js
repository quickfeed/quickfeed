...
var ag_pb = require("./ag_pb");
var AutograderServiceClient = /** @class */ (function () {
    function AutograderServiceClient(hostname, credentials, options) {
        this.methodInfoGetUser = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.User, function (request) {
            return request.serializeBinary();
        }, ag_pb.User.deserializeBinary);
        this.methodInfoGetUsers = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Users, function (request) {
            return request.serializeBinary();
        }, ag_pb.Users.deserializeBinary);
        this.methodInfoGetUserByCourse = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.User, function (request) {
            return request.serializeBinary();
        }, ag_pb.User.deserializeBinary);
        this.methodInfoUpdateUser = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoIsAuthorizedTeacher = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.AuthorizationResponse, function (request) {
            return request.serializeBinary();
        }, ag_pb.AuthorizationResponse.deserializeBinary);
        this.methodInfoGetGroup = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Group, function (request) {
            return request.serializeBinary();
        }, ag_pb.Group.deserializeBinary);
        this.methodInfoGetGroupByUserAndCourse = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Group, function (request) {
            return request.serializeBinary();
        }, ag_pb.Group.deserializeBinary);
        this.methodInfoGetGroupsByCourse = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Groups, function (request) {
            return request.serializeBinary();
        }, ag_pb.Groups.deserializeBinary);
        this.methodInfoCreateGroup = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Group, function (request) {
            return request.serializeBinary();
        }, ag_pb.Group.deserializeBinary);
        this.methodInfoUpdateGroup = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoDeleteGroup = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoGetCourse = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Course, function (request) {
            return request.serializeBinary();
        }, ag_pb.Course.deserializeBinary);
        this.methodInfoGetCourses = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Courses, function (request) {
            return request.serializeBinary();
        }, ag_pb.Courses.deserializeBinary);
        this.methodInfoGetCoursesByUser = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Courses, function (request) {
            return request.serializeBinary();
        }, ag_pb.Courses.deserializeBinary);
        this.methodInfoCreateCourse = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Course, function (request) {
            return request.serializeBinary();
        }, ag_pb.Course.deserializeBinary);
        this.methodInfoUpdateCourse = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoUpdateCourseVisibility = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoGetAssignments = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Assignments, function (request) {
            return request.serializeBinary();
        }, ag_pb.Assignments.deserializeBinary);
        this.methodInfoUpdateAssignments = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoGetEnrollmentsByUser = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Enrollments, function (request) {
            return request.serializeBinary();
        }, ag_pb.Enrollments.deserializeBinary);
        this.methodInfoGetEnrollmentsByCourse = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Enrollments, function (request) {
            return request.serializeBinary();
        }, ag_pb.Enrollments.deserializeBinary);
        this.methodInfoCreateEnrollment = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoUpdateEnrollment = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoUpdateEnrollments = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoGetSubmissions = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Submissions, function (request) {
            return request.serializeBinary();
        }, ag_pb.Submissions.deserializeBinary);
        this.methodInfoGetSubmissionsByCourse = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.CourseSubmissions, function (request) {
            return request.serializeBinary();
        }, ag_pb.CourseSubmissions.deserializeBinary);
        this.methodInfoUpdateSubmission = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoUpdateSubmissions = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoRebuildSubmission = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Submission, function (request) {
            return request.serializeBinary();
        }, ag_pb.Submission.deserializeBinary);
        this.methodInfoCreateBenchmark = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.GradingBenchmark, function (request) {
            return request.serializeBinary();
        }, ag_pb.GradingBenchmark.deserializeBinary);
        this.methodInfoUpdateBenchmark = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoDeleteBenchmark = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoCreateCriterion = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.GradingCriterion, function (request) {
            return request.serializeBinary();
        }, ag_pb.GradingCriterion.deserializeBinary);
        this.methodInfoUpdateCriterion = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoDeleteCriterion = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoCreateReview = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Review, function (request) {
            return request.serializeBinary();
        }, ag_pb.Review.deserializeBinary);
        this.methodInfoUpdateReview = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        this.methodInfoGetReviewers = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Reviewers, function (request) {
            return request.serializeBinary();
        }, ag_pb.Reviewers.deserializeBinary);
        this.methodInfoLoadCriteria = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Benchmarks, function (request) {
            return request.serializeBinary();
        }, ag_pb.Benchmarks.deserializeBinary);
        this.methodInfoGetProviders = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Providers, function (request) {
            return request.serializeBinary();
        }, ag_pb.Providers.deserializeBinary);
        this.methodInfoGetOrganization = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Organization, function (request) {
            return request.serializeBinary();
        }, ag_pb.Organization.deserializeBinary);
        this.methodInfoGetRepositories = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Repositories, function (request) {
            return request.serializeBinary();
        }, ag_pb.Repositories.deserializeBinary);
        this.methodInfoIsEmptyRepo = new grpcWeb.AbstractClientBase.MethodInfo(ag_pb.Void, function (request) {
            return request.serializeBinary();
        }, ag_pb.Void.deserializeBinary);
        if (!options)
            options = {};
