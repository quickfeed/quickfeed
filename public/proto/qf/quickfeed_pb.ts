...
import type { AssignmentsSchema, CourseSchema, CoursesSchema, EnrollmentSchema, EnrollmentsSchema, GradingBenchmarkSchema, GradingCriterionSchema, GroupSchema, GroupsSchema, NotificationSchema, NotificationsSchema, ReviewSchema, SubmissionSchema, SubmissionsSchema, UserSchema, UsersSchema } from "./types_pb";
...
export const file_qf_quickfeed: GenFile = /*@__PURE__*/
  fileDesc("", [file_qf_types, file_qf_requests]);
...
export const QuickFeedService: GenService<{
  ...
  /**
   * @generated from rpc qf.QuickFeedService.GetNotifications
   */
  getNotifications: {
    methodKind: "unary";
    input: typeof VoidSchema;
  ...
  /**
   * @generated from rpc qf.QuickFeedService.SendNotification
   */
  sendNotification: {
    methodKind: "unary";
    input: typeof NotificationSchema;
    output: typeof VoidSchema;
  },
  /**
   * @generated from rpc qf.QuickFeedService.ReadNotification
   */
  readNotification: {
    methodKind: "unary";
    input: typeof NotificationSchema;
  ...
  /**
   * @generated from rpc qf.QuickFeedService.NotificationStream
   */
  notificationStream: {
