...
proto.types.CourseSubmissions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    qf_types_types_pb.EnrollmentLink.toObject, includeInstance)
  };
...
proto.types.CourseSubmissions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new qf_types_types_pb.EnrollmentLink;
      reader.readMessage(value,qf_types_types_pb.EnrollmentLink.deserializeBinaryFromReader);
      msg.addLinks(value);
      break;
    default:
      reader.skipField();
...
proto.types.CourseSubmissions.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      qf_types_types_pb.EnrollmentLink.serializeBinaryToWriter
    );
  }
};
...
proto.types.CourseSubmissions.prototype.getLinksList = function() {
  return /** @type{!Array<!proto.types.EnrollmentLink>} */ (
    jspb.Message.getRepeatedWrapperField(this, qf_types_types_pb.EnrollmentLink, 2));
};
