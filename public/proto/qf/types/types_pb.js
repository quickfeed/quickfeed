...
goog.exportSymbol('proto.types.PullRequest', null, global);
goog.exportSymbol('proto.types.PullRequest.Stage', null, global);
 ...
 * @constructor
 */
proto.types.PullRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.types.PullRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.types.PullRequest.displayName = 'proto.types.PullRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.types.User.repeatedFields_ = [8,9];
...
proto.types.User.prototype.getRemoteidentitiesList = function() {
  return /** @type{!Array<!proto.types.RemoteIdentity>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.types.RemoteIdentity, 8));
};
...
proto.types.User.prototype.addRemoteidentities = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 8, opt_value, proto.types.RemoteIdentity, opt_index);
};
...
proto.types.User.prototype.getEnrollmentsList = function() {
  return /** @type{!Array<!proto.types.Enrollment>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.types.Enrollment, 9));
};
...
proto.types.User.prototype.addEnrollments = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 9, opt_value, proto.types.Enrollment, opt_index);
};
 ...
 * @const
 */
proto.types.Course.repeatedFields_ = [13,14,15];
...
proto.types.Course.prototype.getEnrolled = function() {
  return /** @type {!proto.types.Enrollment.UserStatus} */ (jspb.Message.getFieldWithDefault(this, 12, 0));
};
...
proto.types.Course.prototype.getEnrollmentsList = function() {
  return /** @type{!Array<!proto.types.Enrollment>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.types.Enrollment, 13));
};
...
proto.types.Course.prototype.addEnrollments = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 13, opt_value, proto.types.Enrollment, opt_index);
};
...
proto.types.Course.prototype.getAssignmentsList = function() {
  return /** @type{!Array<!proto.types.Assignment>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.types.Assignment, 14));
};
...
proto.types.Course.prototype.addAssignments = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 14, opt_value, proto.types.Assignment, opt_index);
};
...
proto.types.Course.prototype.getGroupsList = function() {
  return /** @type{!Array<!proto.types.Group>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.types.Group, 15));
};
...
proto.types.Course.prototype.addGroups = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 15, opt_value, proto.types.Group, opt_index);
};
 ...
 * @return {number}
 */
proto.types.UsedSlipDays.prototype.getUseddays = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.types.UsedSlipDays} returns this
 */
proto.types.UsedSlipDays.prototype.setUseddays = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};
 ...
 * @return {!Object}
 */
proto.types.PullRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.types.PullRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.types.PullRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.types.PullRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.types.PullRequest}
 */
proto.types.PullRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.types.PullRequest;
  return proto.types.PullRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.types.PullRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.types.PullRequest}
 */
proto.types.PullRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 8:
      ...
      break;
    case 9:
      var value = /** @type {!proto.types.PullRequest.Stage} */ (reader.readEnum());
      msg.setStage(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.types.PullRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.types.PullRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.types.PullRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.types.PullRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @return {number}
 */
proto.types.PullRequest.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.types.PullRequest} returns this
 */
proto.types.PullRequest.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.types.PullRequest.prototype.getScmrepositoryid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.types.PullRequest} returns this
 */
proto.types.PullRequest.prototype.setScmrepositoryid = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.types.PullRequest.prototype.getTaskid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.types.PullRequest} returns this
 */
proto.types.PullRequest.prototype.setTaskid = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {number}
 */
proto.types.PullRequest.prototype.getIssueid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.types.PullRequest} returns this
 */
proto.types.PullRequest.prototype.setIssueid = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};
 ...
 * @return {number}
 */
proto.types.PullRequest.prototype.getUserid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
 ...
 * @return {!proto.types.PullRequest} returns this
 */
proto.types.PullRequest.prototype.setUserid = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};
 ...
 * @return {number}
 */
proto.types.PullRequest.prototype.getScmcommentid = function() {
 ...
 * @return {!proto.types.PullRequest} returns this
 */
proto.types.PullRequest.prototype.setScmcommentid = function(value) {
 ...
 * @return {string}
 */
proto.types.PullRequest.prototype.getSourcebranch = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 7, ""));
};
 ...
 * @return {!proto.types.PullRequest} returns this
 */
proto.types.PullRequest.prototype.setSourcebranch = function(value) {
  return jspb.Message.setProto3StringField(this, 7, value);
};
 ...
 * @return {number}
 */
proto.types.PullRequest.prototype.getNumber = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 8, 0));
};
 ...
 * @return {!proto.types.PullRequest} returns this
 */
proto.types.PullRequest.prototype.setNumber = function(value) {
  return jspb.Message.setProto3IntField(this, 8, value);
};
 ...
 * @return {!proto.types.PullRequest.Stage}
 */
proto.types.PullRequest.prototype.getStage = function() {
  return /** @type {!proto.types.PullRequest.Stage} */ (jspb.Message.getFieldWithDefault(this, 9, 0));
};


/**
 * @param {!proto.types.PullRequest.Stage} value
 * @return {!proto.types.PullRequest} returns this
 */
proto.types.PullRequest.prototype.setStage = function(value) {
  return jspb.Message.setProto3EnumField(this, 9, value);
};
...
proto.types.SubmissionLink.toObject = function(includeInstance, msg) {
  var f, obj = {
    assignment: (f = msg.getAssignment()) && proto.types.Assignment.toObject(includeInstance, f),
    submission: (f = msg.getSubmission()) && proto.types.Submission.toObject(includeInstance, f)
  };
...
proto.types.SubmissionLink.prototype.getAssignment = function() {
  return /** @type{?proto.types.Assignment} */ (
    jspb.Message.getWrapperField(this, proto.types.Assignment, 1));
};
...
proto.types.SubmissionLink.prototype.getSubmission = function() {
  return /** @type{?proto.types.Submission} */ (
    jspb.Message.getWrapperField(this, proto.types.Submission, 2));
};
...
proto.types.EnrollmentLink.toObject = function(includeInstance, msg) {
  var f, obj = {
    enrollment: (f = msg.getEnrollment()) && proto.types.Enrollment.toObject(includeInstance, f),
    submissionsList: jspb.Message.toObjectList(msg.getSubmissionsList(),
...
proto.types.EnrollmentLink.prototype.getEnrollment = function() {
  return /** @type{?proto.types.Enrollment} */ (
    jspb.Message.getWrapperField(this, proto.types.Enrollment, 2));
};
