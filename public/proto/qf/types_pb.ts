...
export type Course = Message<"qf.Course"> & {
  ...
  /**
   * Invite link to communication platform (e.g., Discord, Slack)
   *
   * @generated from field: string SlackChannelLink = 16;
   */
  SlackChannelLink: string;

  /**
   * Description of the invite link (e.g., "Join our Discord server")
   *
   * @generated from field: string SlackChannelName = 17;
   */
