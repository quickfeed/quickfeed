...
/**
 * @generated from message qf.Notification
 */
export type Notification = Message<"qf.Notification"> & {
  /**
   * @generated from field: uint64 ID = 1;
   */
  ID: bigint;
  ...
  /**
   * @generated from field: uint64 sender = 2;
   */
  sender: bigint;
  ...
  /**
   * @generated from field: uint64 courseID = 7;
   */
  courseID: bigint;

  /**
   * @generated from field: qf.Notification.Type type = 8;
   */
  type: Notification_Type;

  /**
   * @generated from field: qf.Notification.RecipientType recipientType = 9;
   */
   ...
   *
   * @generated from field: bool IsRead = 10;
   */
  IsRead: boolean;
   ...
   *
   * @generated from field: repeated uint64 recipientIDs = 11;
   */
  recipientIDs: bigint[];
  ...
  /**
   * @generated from field: repeated qf.NotificationRecipient recipients = 13;
   */
  recipients: NotificationRecipient[];
};

/**
 * Describes the message qf.Notification.
 ...
 *
 * @generated from enum qf.Notification.Type
 */
export enum Notification_Type {
   ...
   * Only for teachers
   *
   * Add more teacher specific notifications here
   * Needs to be implementend in the server -> internal/notification/*
   * And added to the interface -> internal/notification/notification.go
   *
   * @generated from enum value: ALERT_STUNDENTS_BEHIND = 2;
   */
  ALERT_STUNDENTS_BEHIND = 2,
}

/**
 * Describes the enum qf.Notification.Type.
 */
export const Notification_TypeSchema: GenEnum<Notification_Type> = /*@__PURE__*/
  enumDesc(file_qf_types, 22, 0);

/**
 * @generated from enum qf.Notification.RecipientType
 */
export enum Notification_RecipientType {
  /**
   * @generated from enum value: SELECTIVE = 0;
   */
  SELECTIVE = 0,
  ...
  /**
   * @generated from enum value: STUDENTS = 2;
   */
  STUDENTS = 2,

  /**
   * @generated from enum value: TEACHERS = 3;
   */
  TEACHERS = 3,
}

/**
 * Describes the enum qf.Notification.RecipientType.
 */
export const Notification_RecipientTypeSchema: GenEnum<Notification_RecipientType> = /*@__PURE__*/
  enumDesc(file_qf_types, 22, 1);

/**
 * TODO(Joachim): Switch out with many2many ???
 *
 * @generated from message qf.NotificationRecipient
 */
export type NotificationRecipient = Message<"qf.NotificationRecipient"> & {
  /**
   * @generated from field: uint64 NotificationID = 1;
   */
  ...
  /**
   * @generated from field: google.protobuf.Timestamp read = 3;
   */
  read?: Timestamp;

  /**
   * @generated from field: bool isRead = 4;
   */
  isRead: boolean;
};

/**
 * Describes the message qf.NotificationRecipient.
 * Use `create(NotificationRecipientSchema)` to create a new message.
 */
export const NotificationRecipientSchema: GenMessage<NotificationRecipient> = /*@__PURE__*/
  messageDesc(file_qf_types, 23);

/**
 * @generated from message qf.Notifications
 */
export type Notifications = Message<"qf.Notifications"> & {
  /**
   * @generated from field: repeated qf.Notification notifications = 1;
   */
  notifications: Notification[];
};

/**
 * Describes the message qf.Notifications.
