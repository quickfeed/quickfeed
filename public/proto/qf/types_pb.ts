...
export type AssignmentFeedback = Message<"qf.AssignmentFeedback"> & {
   ...
   *
   * @generated from field: uint32 TimeSpent = 7;
   */
  TimeSpent: number;
