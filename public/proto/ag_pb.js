...
goog.exportSymbol('proto.SlipDays', null, global);
 ...
 * @constructor
 */
proto.SlipDays = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.SlipDays, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.SlipDays.displayName = 'proto.SlipDays';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.Enrollment.repeatedFields_ = [11];
...
proto.Enrollment.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.SlipDays.toObject, includeInstance)
  };
...
proto.Enrollment.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      ...
      break;
    case 11:
      var value = new proto.SlipDays;
      reader.readMessage(value,proto.SlipDays.deserializeBinaryFromReader);
...
proto.Enrollment.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      11,
      f,
      proto.SlipDays.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated SlipDays usedSlipDays = 11;
 * @return {!Array<!proto.SlipDays>}
 */
proto.Enrollment.prototype.getUsedslipdaysList = function() {
  return /** @type{!Array<!proto.SlipDays>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.SlipDays, 11));
};


/**
 * @param {!Array<!proto.SlipDays>} value
 * @return {!proto.Enrollment} returns this
*/
...
/**
 * @param {!proto.SlipDays=} opt_value
 * @param {number=} opt_index
 * @return {!proto.SlipDays}
 */
proto.Enrollment.prototype.addUsedslipdays = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 11, opt_value, proto.SlipDays, opt_index);
};
 ...
 * @return {!Object}
 */
proto.SlipDays.prototype.toObject = function(opt_includeInstance) {
  return proto.SlipDays.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.SlipDays} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SlipDays.toObject = function(includeInstance, msg) {
  var f, obj = {
    assignmentid: jspb.Message.getFieldWithDefault(msg, 1, 0),
    usedslipdays: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * @return {!proto.SlipDays}
 */
proto.SlipDays.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SlipDays;
  return proto.SlipDays.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SlipDays} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SlipDays}
 */
proto.SlipDays.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.SlipDays.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SlipDays.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SlipDays} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SlipDays.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.SlipDays.prototype.getAssignmentid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.SlipDays} returns this
 */
proto.SlipDays.prototype.setAssignmentid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional uint32 usedSlipDays = 2;
 * @return {number}
 */
proto.SlipDays.prototype.getUsedslipdays = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.SlipDays} returns this
 */
proto.SlipDays.prototype.setUsedslipdays = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
...
proto.Assignment.prototype.getSubmissionsList = function() {
  return /** @type{!Array<!proto.Submission>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Submission, 10));
};
...
proto.Assignment.prototype.addSubmissions = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.Submission, opt_index);
};
