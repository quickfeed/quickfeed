...
goog.exportSymbol('proto.CommentWithUser', null, global);
 ...
 * @constructor
 */
proto.CommentWithUser = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.CommentWithUser, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.CommentWithUser.displayName = 'proto.CommentWithUser';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.User.repeatedFields_ = [8,9,10];
 ...
 */
proto.User.prototype.getCommentsList = function() {
  return /** @type{!Array<!proto.Comment>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Comment, 10));
};
 ...
 * @return {!proto.User} returns this
*/
proto.User.prototype.setCommentsList = function(value) {
 ...
 */
proto.User.prototype.addComments = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.Comment, opt_index);
};
 ...
 * @return {!proto.User} returns this
 */
proto.User.prototype.clearCommentsList = function() {
 ...
 * @return {!Array<!proto.Comment>}
 */
proto.Submission.prototype.getCommentsList = function() {
  return /** @type{!Array<!proto.Comment>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Comment, 12));
};
 ...
 * @return {!proto.Submission} returns this
*/
proto.Submission.prototype.setCommentsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 12, value);
};
 ...
 * @return {!proto.Comment}
 */
proto.Submission.prototype.addComments = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 12, opt_value, proto.Comment, opt_index);
};
...
proto.Comment.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    posted: jspb.Message.getFieldWithDefault(msg, 6, "")
  };
 ...
 * @return {number}
 */
proto.DeleteCommentRequest.prototype.getCourseid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.DeleteCommentRequest} returns this
 */
proto.DeleteCommentRequest.prototype.setCourseid = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.CommentWithUser.prototype.toObject = function(opt_includeInstance) {
  return proto.CommentWithUser.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.CommentWithUser} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.CommentWithUser.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.CommentWithUser}
 */
proto.CommentWithUser.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.CommentWithUser;
  return proto.CommentWithUser.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.CommentWithUser} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.CommentWithUser}
 */
proto.CommentWithUser.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.CommentWithUser.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.CommentWithUser.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.CommentWithUser} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.CommentWithUser.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getComment();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.Comment}
 */
proto.CommentWithUser.prototype.getComment = function() {
  return /** @type{?proto.Comment} */ (
    jspb.Message.getWrapperField(this, proto.Comment, 1));
};


/**
 * @param {?proto.Comment|undefined} value
 * @return {!proto.CommentWithUser} returns this
*/
proto.CommentWithUser.prototype.setComment = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.CommentWithUser} returns this
 */
proto.CommentWithUser.prototype.clearComment = function() {
 ...
 * @return {boolean}
 */
proto.CommentWithUser.prototype.hasComment = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.User}
 */
proto.CommentWithUser.prototype.getUser = function() {
  return /** @type{?proto.User} */ (
 ...
 * @return {!proto.CommentWithUser} returns this
*/
proto.CommentWithUser.prototype.setUser = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.CommentWithUser} returns this
 */
proto.CommentWithUser.prototype.clearUser = function() {
  return this.setUser(undefined);
};
 ...
 * @return {boolean}
 */
proto.CommentWithUser.prototype.hasUser = function() {
  return jspb.Message.getField(this, 2) != null;
};
