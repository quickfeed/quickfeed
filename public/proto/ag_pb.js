...
proto.ActionRequest.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    groupstatus: jspb.Message.getFieldWithDefault(msg, 7, 0)
  };
 ...
 * @return {string}
 */
proto.ActionRequest.prototype.getProvider = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};


/** @param {string} value */
proto.ActionRequest.prototype.setProvider = function(value) {
  jspb.Message.setProto3StringField(this, 5, value);
};


/**
 * optional Enrollment.UserStatus status = 6;
 * @return {!proto.Enrollment.UserStatus}
 */
proto.ActionRequest.prototype.getStatus = function() {
  return /** @type {!proto.Enrollment.UserStatus} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};
...
/**
 * optional Group.GroupStatus groupStatus = 7;
 * @return {!proto.Group.GroupStatus}
 */
proto.ActionRequest.prototype.getGroupstatus = function() {
  return /** @type {!proto.Group.GroupStatus} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
