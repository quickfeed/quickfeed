...
goog.exportSymbol('proto.AssignmentLink', null, global);
...
goog.exportSymbol('proto.SubmissionLinkRequest', null, global);
goog.exportSymbol('proto.SubmissionLinkRequest.Type', null, global);
 ...
 * @constructor
 */
proto.AssignmentLink = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.AssignmentLink.repeatedFields_, null);
};
goog.inherits(proto.AssignmentLink, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.AssignmentLink.displayName = 'proto.AssignmentLink';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.SubmissionLinkRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.SubmissionLinkRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.SubmissionLinkRequest.displayName = 'proto.SubmissionLinkRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.Assignment.repeatedFields_ = [10];
...
proto.Assignment.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.Submissions.toObject, includeInstance)
  };
...
/**
 * repeated Submissions submissions = 10;
 * @return {!Array<!proto.Submissions>}
 */
proto.Assignment.prototype.getSubmissionsList = function() {
  return /** @type{!Array<!proto.Submissions>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Submissions, 10));
};


/**
 * @param {!Array<!proto.Submissions>} value
 * @return {!proto.Assignment} returns this
*/
...
/**
 * @param {!proto.Submissions=} opt_value
 * @param {number=} opt_index
 * @return {!proto.Submissions}
 */
proto.Assignment.prototype.addSubmissions = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.Submissions, opt_index);
};
 ...
 * @const
 */
proto.AssignmentLink.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.AssignmentLink.prototype.toObject = function(opt_includeInstance) {
  return proto.AssignmentLink.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.AssignmentLink} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.AssignmentLink.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.AssignmentLink}
 */
proto.AssignmentLink.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.AssignmentLink;
  return proto.AssignmentLink.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.AssignmentLink} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.AssignmentLink}
 */
proto.AssignmentLink.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.AssignmentLink.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.AssignmentLink.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.AssignmentLink} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.AssignmentLink.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {?proto.Enrollment}
 */
proto.AssignmentLink.prototype.getEnrollment = function() {
 ...
 * @return {!proto.AssignmentLink} returns this
*/
proto.AssignmentLink.prototype.setEnrollment = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.AssignmentLink} returns this
 */
proto.AssignmentLink.prototype.clearEnrollment = function() {
 ...
 * @return {boolean}
 */
proto.AssignmentLink.prototype.hasEnrollment = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 */
proto.AssignmentLink.prototype.getSubmissionsList = function() {
 ...
 * @return {!proto.AssignmentLink} returns this
*/
proto.AssignmentLink.prototype.setSubmissionsList = function(value) {
 ...
 * @return {!proto.SubmissionLink}
 */
proto.AssignmentLink.prototype.addSubmissions = function(opt_value, opt_index) {
 ...
 * @return {!proto.AssignmentLink} returns this
 */
proto.AssignmentLink.prototype.clearSubmissionsList = function() {
  return this.setSubmissionsList([]);
};
...
proto.CourseSubmissions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.AssignmentLink.toObject, includeInstance)
  };
...
proto.CourseSubmissions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.AssignmentLink;
      reader.readMessage(value,proto.AssignmentLink.deserializeBinaryFromReader);
      msg.addLinks(value);
      break;
    default:
      reader.skipField();
...
proto.CourseSubmissions.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.AssignmentLink.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated AssignmentLink links = 2;
 * @return {!Array<!proto.AssignmentLink>}
 */
proto.CourseSubmissions.prototype.getLinksList = function() {
  return /** @type{!Array<!proto.AssignmentLink>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.AssignmentLink, 2));
};


/**
 * @param {!Array<!proto.AssignmentLink>} value
 * @return {!proto.CourseSubmissions} returns this
*/
...
/**
 * @param {!proto.AssignmentLink=} opt_value
 * @param {number=} opt_index
 * @return {!proto.AssignmentLink}
 */
proto.CourseSubmissions.prototype.addLinks = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.AssignmentLink, opt_index);
};
 ...
 * @return {!Object}
 */
proto.SubmissionLinkRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.SubmissionLinkRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.SubmissionLinkRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SubmissionLinkRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    courseid: jspb.Message.getFieldWithDefault(msg, 1, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.SubmissionLinkRequest}
 */
proto.SubmissionLinkRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SubmissionLinkRequest;
  return proto.SubmissionLinkRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SubmissionLinkRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SubmissionLinkRequest}
 */
proto.SubmissionLinkRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.SubmissionLinkRequest.Type} */ (reader.readEnum());
      msg.setType(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.SubmissionLinkRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SubmissionLinkRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SubmissionLinkRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SubmissionLinkRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCourseid();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @enum {number}
 */
proto.SubmissionLinkRequest.Type = {
  ALL: 0,
  INDIVIDUAL: 1,
  GROUP: 2
};
 ...
 * @return {number}
 */
proto.SubmissionLinkRequest.prototype.getCourseid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.SubmissionLinkRequest} returns this
 */
proto.SubmissionLinkRequest.prototype.setCourseid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!proto.SubmissionLinkRequest.Type}
 */
proto.SubmissionLinkRequest.prototype.getType = function() {
  return /** @type {!proto.SubmissionLinkRequest.Type} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.SubmissionLinkRequest.Type} value
 * @return {!proto.SubmissionLinkRequest} returns this
 */
proto.SubmissionLinkRequest.prototype.setType = function(value) {
