                ...
                <div className="navbar-collapse ml-auto">
                    <ul className="ms-auto ml-auto list-unstyled">
                        <li className="nav-item">
                            <a href="/auth/github" style={{ textAlign: "center", paddingTop: "15px", color: "#d4d4d4", marginLeft: "40px" }} role="button">
            ...
            {state.isLoggedIn &&
                <ul className="mr-auto me-auto list-unstyled">
                    <a className="clickable" onClick={() => { onCourseClick() }}
                        style={{ paddingTop: "15px", marginLeft: "10px", fontSize: 25 }} role="button">☰</a>
                </ul>
