...
export class ReviewRequest extends jspb.Message {
  ...
  getReview(): ag_types_types_pb.Review | undefined;
  setReview(value?: ag_types_types_pb.Review): ReviewRequest;
  hasReview(): boolean;
...
export namespace ReviewRequest {
  export type AsObject = {
    courseid: number,
    review?: ag_types_types_pb.Review.AsObject,
  }
}

export class BenchmarkRequest extends jspb.Message {
  getCourseid(): number;
  setCourseid(value: number): BenchmarkRequest;

  getBenchmark(): ag_types_types_pb.GradingBenchmark | undefined;
  setBenchmark(value?: ag_types_types_pb.GradingBenchmark): BenchmarkRequest;
  hasBenchmark(): boolean;
  clearBenchmark(): BenchmarkRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): BenchmarkRequest.AsObject;
  static toObject(includeInstance: boolean, msg: BenchmarkRequest): BenchmarkRequest.AsObject;
  static serializeBinaryToWriter(message: BenchmarkRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): BenchmarkRequest;
  static deserializeBinaryFromReader(message: BenchmarkRequest, reader: jspb.BinaryReader): BenchmarkRequest;
}

export namespace BenchmarkRequest {
  export type AsObject = {
    courseid: number,
    benchmark?: ag_types_types_pb.GradingBenchmark.AsObject,
  }
}

export class CriteriaRequest extends jspb.Message {
  getCourseid(): number;
  setCourseid(value: number): CriteriaRequest;

  getCriterion(): ag_types_types_pb.GradingCriterion | undefined;
  setCriterion(value?: ag_types_types_pb.GradingCriterion): CriteriaRequest;
  hasCriterion(): boolean;
  clearCriterion(): CriteriaRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CriteriaRequest.AsObject;
  static toObject(includeInstance: boolean, msg: CriteriaRequest): CriteriaRequest.AsObject;
  static serializeBinaryToWriter(message: CriteriaRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CriteriaRequest;
  static deserializeBinaryFromReader(message: CriteriaRequest, reader: jspb.BinaryReader): CriteriaRequest;
}

export namespace CriteriaRequest {
  export type AsObject = {
    courseid: number,
    criterion?: ag_types_types_pb.GradingCriterion.AsObject,
  }
}
...
export class EnrollmentRequest extends jspb.Message {
  ...
  getStatusesList(): Array<ag_types_types_pb.Enrollment.UserStatus>;
  setStatusesList(value: Array<ag_types_types_pb.Enrollment.UserStatus>): EnrollmentRequest;
  clearStatusesList(): EnrollmentRequest;
  addStatuses(value: ag_types_types_pb.Enrollment.UserStatus, index?: number): EnrollmentRequest;
...
export namespace EnrollmentRequest {
  export type AsObject = {
    ...
    statusesList: Array<ag_types_types_pb.Enrollment.UserStatus>,
  }
}
...
export class EnrollmentStatusRequest extends jspb.Message {
  ...
  getStatusesList(): Array<ag_types_types_pb.Enrollment.UserStatus>;
  setStatusesList(value: Array<ag_types_types_pb.Enrollment.UserStatus>): EnrollmentStatusRequest;
  clearStatusesList(): EnrollmentStatusRequest;
  addStatuses(value: ag_types_types_pb.Enrollment.UserStatus, index?: number): EnrollmentStatusRequest;
...
export class UpdateSubmissionRequest extends jspb.Message {
  ...
  getStatus(): ag_types_types_pb.Submission.Status;
  setStatus(value: ag_types_types_pb.Submission.Status): UpdateSubmissionRequest;
...
export namespace UpdateSubmissionRequest {
  export type AsObject = {
    ...
    score: number,
    released: boolean,
    status: ag_types_types_pb.Submission.Status,
  }
}
...
export class SubmissionLink extends jspb.Message {
  getAssignment(): ag_types_types_pb.Assignment | undefined;
  setAssignment(value?: ag_types_types_pb.Assignment): SubmissionLink;
  hasAssignment(): boolean;
  clearAssignment(): SubmissionLink;

  getSubmission(): ag_types_types_pb.Submission | undefined;
  setSubmission(value?: ag_types_types_pb.Submission): SubmissionLink;
...
export namespace SubmissionLink {
  export type AsObject = {
    assignment?: ag_types_types_pb.Assignment.AsObject,
    submission?: ag_types_types_pb.Submission.AsObject,
  }
}

export class EnrollmentLink extends jspb.Message {
  getEnrollment(): ag_types_types_pb.Enrollment | undefined;
  setEnrollment(value?: ag_types_types_pb.Enrollment): EnrollmentLink;
...
export namespace EnrollmentLink {
  export type AsObject = {
    enrollment?: ag_types_types_pb.Enrollment.AsObject,
    submissionsList: Array<SubmissionLink.AsObject>,
  }
}

export class CourseSubmissions extends jspb.Message {
  getCourse(): ag_types_types_pb.Course | undefined;
  setCourse(value?: ag_types_types_pb.Course): CourseSubmissions;
  hasCourse(): boolean;
...
export namespace CourseSubmissions {
  export type AsObject = {
    course?: ag_types_types_pb.Course.AsObject,
...
export class URLRequest extends jspb.Message {
  ...
  getRepotypesList(): Array<ag_types_types_pb.Repository.Type>;
  setRepotypesList(value: Array<ag_types_types_pb.Repository.Type>): URLRequest;
  clearRepotypesList(): URLRequest;
  addRepotypes(value: ag_types_types_pb.Repository.Type, index?: number): URLRequest;
...
export namespace URLRequest {
  export type AsObject = {
    courseid: number,
    repotypesList: Array<ag_types_types_pb.Repository.Type>,
  }
}
...
export class Reviewers extends jspb.Message {
  getReviewersList(): Array<ag_types_types_pb.User>;
  setReviewersList(value: Array<ag_types_types_pb.User>): Reviewers;
  clearReviewersList(): Reviewers;
  addReviewers(value?: ag_types_types_pb.User, index?: number): ag_types_types_pb.User;
...
export namespace Reviewers {
  export type AsObject = {
    reviewersList: Array<ag_types_types_pb.User.AsObject>,
  }
}
