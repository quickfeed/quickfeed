...
proto_$(1):
	...
	ag/ag.proto ag/types/types.proto ag/types/requests.proto kit/score/score.proto
	...
	$(1)/proto/ag/types/requests_pb.d.ts \
	$(1)/proto/ag/types/types_pb.d.ts \
	$(1)/proto/ag/types/types_pb.js
...
run-envoy: envoy-config-local
	@sudo getenvoy run -c $$ENVOY_CONFIG &

run-envoy-local: envoy-config-old
	@sudo getenvoy run -c $$ENVOY_CONFIG &
