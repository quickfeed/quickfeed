...
These instructions should also work on Windows with WSL. First, make sure that you have installed Go, npm, npm(webpack), Envoy and Nginx. VIM is recommended for editing specific files.
...
server {
        ...
        server_name 127.0.0.1/auth/github/callback;
        location / {
