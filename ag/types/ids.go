...
// GetRoleID methods for userRequest, courseRequest, GroupR interface used in access control
...
// FetchID returns course ID
func (r *BenchmarkRequest) FetchID(_ string) uint64 {
	return r.GetCourseID()
}

// FetchID returns course ID
func (r *CriteriaRequest) FetchID(_ string) uint64 {
	return r.GetCourseID()
}
