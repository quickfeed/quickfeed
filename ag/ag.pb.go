...
type Issue struct {
	...
	GithubRepositoryID uint64 `protobuf:"varint,3,opt,name=githubRepositoryID,proto3" json:"githubRepositoryID,omitempty"` // Represents the ID of a repository given by github
	Name               string `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`                              // Name of associated task/issue, e.g. "task-1"
...
var file_ag_ag_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xa9, 0x01, 0x0a, 0x05, 0x49, 0x73,
	...
	0x62, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x49, 0x44, 0x18, 0x03, 0x20,
