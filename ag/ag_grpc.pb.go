...
type AutograderServiceClient interface {
	...
	BuildSubmission(ctx context.Context, in *BuildRequest, opts ...grpc.CallOption) (*Submission, error)
...
func (c *autograderServiceClient) BuildSubmission(ctx context.Context, in *BuildRequest, opts ...grpc.CallOption) (*Submission, error) {
	out := new(Submission)
	err := c.cc.Invoke(ctx, "/ag.AutograderService/BuildSubmission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AutograderServiceServer interface {
	...
	BuildSubmission(context.Context, *BuildRequest) (*Submission, error)
...
func (UnimplementedAutograderServiceServer) BuildSubmission(context.Context, *BuildRequest) (*Submission, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BuildSubmission not implemented")
}
...
func _AutograderService_BuildSubmission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BuildRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AutograderServiceServer).BuildSubmission(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ag.AutograderService/BuildSubmission",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AutograderServiceServer).BuildSubmission(ctx, req.(*BuildRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AutograderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BuildSubmission",
			Handler:    _AutograderService_BuildSubmission_Handler,
		},
		{
