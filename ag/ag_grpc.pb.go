...
func (c *autograderServiceClient) UpdateGroup(ctx context.Context, in *Group, opts ...grpc.CallOption) (*Group, error) {
	out := new(Group)
...
func (UnimplementedAutograderServiceServer) UpdateGroup(context.Context, *Group) (*Group, error) {
