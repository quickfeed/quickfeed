...
func (s *GitlabSCM) CreateOrganization(ctx context.Context, opt *OrganizationOptions) (*types.Organization, error) {
...
func (s *GitlabSCM) GetOrganization(ctx context.Context, opt *GetOrgOptions) (*types.Organization, error) {
...
func (s *GitlabSCM) GetRepositories(ctx context.Context, directory *types.Organization) ([]*Repository, error) {
	var gid interface{}
	if directory.Path != "" {
		gid = directory.Path
	} else {
...
func (*GitlabSCM) GetTeams(_ context.Context, _ *types.Organization) ([]*Team, error) {
	return nil, ErrNotSupported{
		SCM:    "gitlab",
		Method: "GetTeam",
	}
