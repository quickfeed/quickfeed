...
func (*GithubSCM) CreateOrganization(ctx context.Context, opt *OrganizationOptions) (*types.Organization, error) {
...
func (s *GithubSCM) GetOrganization(ctx context.Context, opt *GetOrgOptions) (*types.Organization, error) {
	if !opt.valid() {
...
func (s *GithubSCM) GetRepositories(ctx context.Context, org *types.Organization) ([]*Repository, error) {
	if !org.IsValid() {
		return nil, ErrMissingFields{
...
func (s *GithubSCM) GetTeams(ctx context.Context, org *types.Organization) ([]*Team, error) {
	if !org.IsValid() {
		return nil, ErrMissingFields{
			Method:  "GetTeams",
			Message: fmt.Sprintf("%+v", org),
