...
type SCM interface {
	...
	CreateOrganization(context.Context, *OrganizationOptions) (*types.Organization, error)
	// Updates an organization
	UpdateOrganization(context.Context, *OrganizationOptions) error
	// Gets an organization.
	GetOrganization(context.Context, *GetOrgOptions) (*types.Organization, error)
	...
	GetRepositories(context.Context, *types.Organization) ([]*Repository, error)
	// Delete repository.
	...
	GetTeams(context.Context, *types.Organization) ([]*Team, error)
	// Add repo to team.
