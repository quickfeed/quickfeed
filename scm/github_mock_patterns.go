...
const (
	...
	getReposCommitsByOwnerByRepoByRef                         = "GET /repos/{owner}/{repo}/commits/{ref}"                            // hasNoCommitsAhead
	getReposCompareByOwnerByRepoByBaseByHead                  = "GET /repos/{owner}/{repo}/compare/{basehead}"                       // RepositoryIsEmpty, hasNoCommitsAhead
