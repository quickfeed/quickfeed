...
func TestMockUpdateIssueComment(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "meling-labs", CommentID: 1, Body: "World 1.1"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(1), Body: new("World 1.1")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "meling-labs", CommentID: 2, Body: "World 1.2"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(2), Body: new("World 1.2")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "meling-labs", CommentID: 3, Body: "World 1.3"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(3), Body: new("World 1.3")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "meling-labs", CommentID: 4, Body: "World 2.1"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(4), Body: new("World 2.1")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "meling-labs", CommentID: 5, Body: "World 2.2"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(5), Body: new("World 2.2")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "meling-labs", CommentID: 6, Body: "World 2.3"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(6), Body: new("World 2.3")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "josie-labs", CommentID: 7, Body: "World 1.1"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(7), Body: new("World 1.1")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "josie-labs", CommentID: 8, Body: "World 1.2"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(8), Body: new("World 1.2")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "josie-labs", CommentID: 9, Body: "World 1.3"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(9), Body: new("World 1.3")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "josie-labs", CommentID: 10, Body: "World 2.1"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(10), Body: new("World 2.1")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "josie-labs", CommentID: 11, Body: "World 2.2"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(11), Body: new("World 2.2")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "foo", Repository: "josie-labs", CommentID: 12, Body: "World 2.3"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(12), Body: new("World 2.3")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "dat320", Repository: "meling-labs", CommentID: 13, Body: "World 1.1"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(13), Body: new("World 1.1")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "dat320", Repository: "meling-labs", CommentID: 14, Body: "World 1.2"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(14), Body: new("World 1.2")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "dat320", Repository: "meling-labs", CommentID: 15, Body: "World 1.3"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(15), Body: new("World 1.3")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "dat320", Repository: "meling-labs", CommentID: 16, Body: "World 2.1"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(16), Body: new("World 2.1")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "dat320", Repository: "meling-labs", CommentID: 17, Body: "World 2.2"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(17), Body: new("World 2.2")}},
		{name: "CompleteRequest", opt: &IssueCommentOptions{Organization: "dat320", Repository: "meling-labs", CommentID: 18, Body: "World 2.3"}, wantErr: false, wantComment: github.IssueComment{ID: github.Int64(18), Body: new("World 2.3")}},
	}
	for _, tt := range tests {
		name := qtest.Name(
			tt.name,
